<?php
    ...
    class Date
    {
        ...
        public static function getPeriodReadable($value, $days)
        {
            ...
            switch ($value) {
                case "D":
                    $result = $days > 1 ? Lang::$word->_DAYS : Lang::$word->_DAY;
                    break;
                case "W":
                    $result = $days > 1 ? Lang::$word->_WEEKS : Lang::$word->_WEEK;
                    break;
                case "M":
                    $result = $days > 1 ? Lang::$word->_MONTHS : Lang::$word->_MONTH;
                    break;
                case "Y":
                    $result = $days > 1 ? Lang::$word->_YEARS : Lang::$word->_YEAR;
                    break;
            }
