    ...
    class Content
    {
        ...
        public function processLocation($front = false)
        {
            ...
            $validate
                ...
                ->set("state", Lang::$word->STATE)->string()
                ->set("country", Lang::$word->COUNTRY)->required()->string()
                ->set("zip", Lang::$word->ZIP)->string()
        ...
        public function processPackage()
        {
            ...
            $validate
                ...
                ->set("description", Lang::$word->DESC)->required()->string();
        ...
        public function processMenu()
        {
            ...
            if (empty(Message::$msgs)) {
                $data = array(
                    ...
                    'target' => (empty($_POST['target'])) ? "_self" : Validator::sanitize($_POST['target'], "db"),
        ...
        public function processPage()
        {
            ...
            if (empty(Message::$msgs)) {
                ...
                if (Filter::$id) {
                    ...
                    Db::Go()->insert(self::pgTable, $data)->run();
                }
        ...
        public function processEmail()
        {
            ...
            $validate
                ...
                ->set("body", Lang::$word->EMN_REC_SEL)->text("advanced");
            ...
            if (empty(Message::$msgs)) {
                ...
                switch ($to) {
                    ...
                    default:
                        ...
                        $row = Db::Go()->rawQuery("SELECT email, CONCAT(fname,' ',lname) as name FROM `" . $table . "` WHERE email LIKE '%" . $to . "%'")->first()->run();
                        break;
