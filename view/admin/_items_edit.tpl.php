      ...
      <div class="wojo basic tab">
         <div data-tab="general" class="item">
            <div class="wojo segment form">
               ...
               <div class="wojo fields">
                  ...
                  <div class="field">
                     <label><?php echo Lang::$word->EXPIRE; ?>
                        <span data-tooltip="<?php echo Lang::$word->LST_EXPIRE_T; ?>" data-position="top left"><i class="icon question circle"></i></span>
                     </label>
                                 ...
                                 <div class="columns" id="item_<?php echo $grow->id; ?>" data-id="<?php echo $grow->id; ?>">
                                    <div class="wojo attached simple fitted segment center aligned">
                                       ...
                                       <div class="wojo buttons middle attached">
                                          <a data-set='{"option":[{"action":"editGallery","id": <?php echo $grow->id; ?>}], "label":"<?php echo Lang::$word->EDIT; ?>", "url":"helper.php", "parent":"#title_<?php echo $grow->id; ?>", "complete":"replace", "modalclass":"normal"}' class="wojo small icon positive button action">
                                             <i class="icon pencil line"></i>
                                          </a>
                                          <a data-set='{"option":[{"delete": "deleteGallery","title": "<?php echo Validator::sanitize($grow->title, "chars"); ?>","id": <?php echo $grow->id; ?>}],"action":"delete","parent":"#item_<?php echo $grow->id; ?>"}' class="wojo small icon negative button data">
         ...
         <div data-tab="description" class="item">
            <div class="wojo segment form">
               <div class="wojo fields">
                  <div class="field">
                     <label><?php echo Lang::$word->LST_NAME; ?>
                        <span data-tooltip="<?php echo Lang::$word->LST_NAME_T; ?>" data-position="top left"><i class="icon question circle"></i></span>
                     </label>
                     <input type="text" placeholder="<?php echo Lang::$word->LST_NAME; ?>" value="<?php echo $this->row->title; ?>" name="title">
                  </div>
                  <div class="field">
                     <label><?php echo Lang::$word->LST_SLUG; ?>
                        <span data-tooltip="<?php echo Lang::$word->LST_SLUG_T; ?>" data-position="top left"><i class="icon question circle"></i></span>
                     </label>
