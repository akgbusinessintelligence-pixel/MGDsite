         ...
         <div data-tab="general" class="item">
            <div class="wojo segment form">
                  ...
                  <div class="field">
                     ...
                     <div class="wojo action input">
                        ...
                        <?php if ($this->core->vinapi): ?>
                           <button type="button" class="wojo primary inverted icon button" id="dovin">
                              <i
                                class="icon search"></i>
                           </button>
                        <?php endif; ?>
               ...
               <div class="wojo fields">
                  ...
                  <div class="field">
                     <label><?php echo Lang::$word->LST_YTUBE; ?>
                        <span data-tooltip="<?php echo Lang::$word->LST_YTUBE_T; ?>" data-position="top left"><i class="icon question circle"></i></span>
                     </label>
                     <input type="text" placeholder="<?php echo Lang::$word->LST_YTUBE; ?>" name="ylink">
                  </div>
                  <div class="field">
                     <label><?php echo Lang::$word->LST_LPLATE; ?></label>
                     <input type="text" placeholder="<?php echo Lang::$word->LST_LPLATE; ?>" name="lplate">
                  </div>
               </div>
               <div class="wojo fields">
                  <div class="field">
               ...
               <div class="wojo fields">
                  ...
                  <div class="field">
                     <label><?php echo Lang::$word->EXPIRE; ?>
                        <span data-tooltip="<?php echo Lang::$word->LST_EXPIRE_T; ?>"
                              data-position="top left"><i class="icon question circle"></i></span>
                     </label>
               ...
               <div class="wojo fields">
                  <div class="field">
                     <label><?php echo Lang::$word->LST_NAME; ?>
                        <span data-tooltip="<?php echo Lang::$word->LST_NAME_T; ?>"
                              data-position="top left"><i class="icon question circle"></i></span>
                     </label>
                  ...
                  <div class="field">
                     <label><?php echo Lang::$word->LST_SLUG; ?>
                        <span data-tooltip="<?php echo Lang::$word->LST_SLUG_T; ?>"
                              data-position="top left"><i class="icon question circle"></i></span>
                     </label>
