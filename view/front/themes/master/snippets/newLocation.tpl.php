      ...
      <form method="post" id="modal_form" name="modal_form">
         <div class="wojo block fields">
            ...
            <div class="field">
               ...
               <input type="text" placeholder="<?php echo Lang::$word->CITY; ?>" value="<?php echo $_GET['city'] ?? null; ?>" name="city_alt">
            </div>
            <div class="field">
               <label><?php echo Lang::$word->STATE; ?>
                  <i class="icon asterisk"></i>
               </label>
               <input type="text" placeholder="<?php echo Lang::$word->STATE; ?>" value="<?php echo $_GET['state'] ?? null; ?>" name="state_alt">
            </div>
            <div class="field">
               <label><?php echo Lang::$word->ZIP; ?>
                  <i class="icon asterisk"></i>
               </label>
               <input type="text" placeholder="<?php echo Lang::$word->ZIP; ?>" value="<?php echo $_GET['zip'] ?? null; ?>" name="zip_alt">
            </div>
            <div class="field">
