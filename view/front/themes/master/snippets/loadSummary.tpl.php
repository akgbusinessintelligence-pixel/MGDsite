...
<div class="wojo form">
   <table class="wojo basic unstackable table">
      ...
      <tr>
         <td>
            <strong><?php echo Lang::$word->MSM_NAME; ?></strong>
         </td>
         <td><?php echo $this->row->title; ?></td>
      </tr>
      <tr>
         <td>
            <strong><?php echo Lang::$word->MSM_PRICE; ?></strong>
         </td>
         <td><?php echo Utility::formatMoney($this->cart->total); ?></td>
      </tr>
      <tr>
         <td>
            <strong><?php echo Lang::$word->DISC; ?>
            </strong>
         </td>
      ...
      <?php if (App::Core()->enable_tax): ?>
         <tr>
            <td>
               <strong><?php echo Lang::$word->TRX_TAX; ?></strong>
            </td>
      ...
      <tr>
         <td>
            <strong><?php echo Lang::$word->MSM_VALIDTO; ?></strong>
         </td>
         <td><?php echo Date::doDate("short_date", Date::calculateDays($this->row->id)); ?></td>
      </tr>
      <tr>
         <td>
            <strong><?php echo Lang::$word->DESCRIPTION; ?></strong>
         </td>
         <td><?php echo $this->row->description; ?></td>
      </tr>
      <tr>
         <td>
            <strong><?php echo Lang::$word->DC_CODE; ?></strong>
         </td>
         <td>
            <div class="wojo small action input">
               <input type="text" placeholder="<?php echo Lang::$word->DC_CODE_I; ?>" name="coupon">
               <button name="discount" class="wojo primary icon button" data-id="<?php echo $this->row->id; ?>">
      ...
      <tr id="gatedata">
         <td>
            <strong><?php echo Lang::$word->M_P_PAYWITH; ?></strong>
         </td>
         <td>
            ...
            <div id="gateList">
               <div class="row grid phone-2 mobile-3 tablet-4 screen-5 small gutters align center">
                  <?php foreach ($this->gateways as $grows): ?>
                     <div class="columns">
                        <a class="wojo basic light icon fluid button sGateway" data-id="<?php echo $grows->id; ?>">
                           <img src="<?php echo SITEURL; ?>/gateways/<?php echo $grows->dir; ?>/<?php echo $grows->name; ?>_logo.svg" alt=""><?php //echo $grows->displayname;?></a>
                     </div>
                  <?php endforeach; ?>
               </div>
            </div>
