               ...
               <?php if ($this->featured): ?>
                  <div class="wojo attached photo card full">
                     <a class="wojo full zoom top rounded image"
                        ...
                        <?php if ($this->featured[0]->sold): ?>
                           <div class="wojo bookmark"><?php echo Lang::$word->SOLD; ?></div>
                        <?php endif; ?>
                        <img src="<?php echo UPLOADURL . '/listings/' . $this->featured[0]->thumb; ?>"
                             alt="<?php echo $this->featured[0]->nice_title; ?>">
                     </a>
                     <div class="footer wojo secondary bg">
                        <h5 class="basic wojo light text truncate">
                           <a class="white" href="<?php echo Url::url("/listing/" . $this->featured[0]->idx, $this->featured[0]->slug . "/"); ?>"><?php echo $this->featured[0]->nice_title; ?></a>
                        </h5>
                        <span class="wojo demi white text screen-hide tablet-hide mobile-hide"><?php echo Utility::formatMoney($this->featured[0]->price); ?></span>
                        ...
                        <div class="row small horizontal gutters align middle">
                           <div class="columns auto"><span
                                class="wojo primary label"><?php echo $this->featured[0]->year; ?></span>
                           </div>
                           <div class="columns auto"><span
                                class="wojo demi text"><?php echo $this->featured[0]->transmission; ?></span>
                           </div>
                           <div class="columns auto"><span
                                class="wojo demi text"><?php echo $this->featured[0]->fuel; ?></span>
                           </div>
                           <div class="columns auto"><span
                                class="wojo demi text"><?php echo $this->featured[0]->drive_train; ?></span>
                           </div>
                           <div class="columns wojo right aligned phone-hide"><span
                  ...
                  <?php foreach ($this->special as $i => $srow): ?>
                     <div class="columns<?php echo(($i == 2 or $i == 3)? " end" : null); ?>">
                        <div class="wojo attached photo full card">
                           <a class="wojo full zoom top rounded image"
                              href="<?php echo Url::url("/listing/" . $srow->idx, $srow->slug . "/"); ?>">
                              <?php if ($srow->sold): ?>
                                 <div class="wojo bookmark"><?php echo Lang::$word->SOLD; ?></div>
                              <?php endif; ?>
                              <img
                                src="<?php echo UPLOADURL . '/listings/' . $srow->thumb; ?>"
                                alt="<?php echo $srow->nice_title; ?>">
                           </a>
                           <div class="footer wojo secondary bg">
                              ...
                              <div class="row small horizontal gutters align middle">
                                 <div class="columns auto"><span
                                      class="wojo small primary label"><?php echo $srow->year; ?></span>
                                 </div>
                                 <div class="columns auto"><span
                                      class="wojo small text"><?php echo $srow->transmission; ?></span>
                                 </div>
                                 <div class="columns auto">
                                    <span class="wojo small text"><?php echo $srow->fuel; ?></span>
                                 </div>
                              </div>
                           </div>
                        </div>
