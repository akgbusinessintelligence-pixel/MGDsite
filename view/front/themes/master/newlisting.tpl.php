            ...
            <div class="columns screen-70 tablet-100 mobile-100 phone-100">
               ...
               <form method="post" id="wojo_form" name="wojo_form">
                  <div class="wojo basic segment form">
                     ...
                     <div class="wojo fields">
                        <div class="field">
                           <label><?php echo Lang::$word->LST_ODM; ?>
                              <i class="icon asterisk"></i>
                           </label>
                        ...
                        <div class="field">
                           ...
                           <input type="text" placeholdder="<?php echo Lang::$word->LST_LPLATE; ?>" name="lplate">
                        </div>
                     </div>
                     <div class="wojo fields">
                        <div class="field">
                     ...
                     <div class="wojo fields">
                        <div class="field">
                           ...
                           <p class="wojo icon text">
                              <i class="icon info square"></i><?php echo Lang::$word->LOC_INFO3; ?></p>
                        </div>
                  ...
                  <input type="hidden" data-geo="formatted_address" name="address">
