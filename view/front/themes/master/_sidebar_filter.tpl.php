         ...
         <div class="item align middle">
            <div class="columns">
               <a rel="nofollow" href="<?php echo Url::buildUrl("sale", "sale", false); ?>"
                  class="item">
                  <strong><?php echo Lang::$word->HOME_SPCL; ?></strong>
               </a>
            </div>
         </div>
               ...
               <div class="item align middle">
                  <div class="columns">
                     <a rel="nofollow"
                        ...
                        class="item">
                        <strong><?php echo $cond->condition_name; ?></strong>
                     </a>
                  </div>
                  <div class="columns auto">
                     <span class="wojo demi text">(<?php echo $cond->total; ?>)</span>
                  </div>
               </div>
            <?php endforeach; ?>
         <?php endif; ?>
         ...
         <div class="wojo small divided items">
            <?php foreach (Utility::jSonToArray($this->core->makes) as $makes): ?>
               <div class="item align middle">
                  ...
                  <div class="columns auto">
                     <span class="wojo demi text">(<?php echo $makes->total; ?>)</span>
                  </div>
               </div>
            <?php endforeach; ?>
         </div>
         ...
         <div class="wojo small divided items">
            <?php foreach (Utility::jSonToArray($this->core->color) as $color): ?>
               <div class="item align middle">
                  ...
                  <div class="columns auto">
                     <span class="wojo demi text">(<?php echo $color->total; ?>)</span>
                  </div>
               </div>
            <?php endforeach; ?>
         </div>
         ...
         <div class="wojo small divided items">
            <?php foreach (Utility::jSonToArray($this->core->category_list) as $category): ?>
               <div class="item align middle">
                  <div class="columns">
                     <a rel="nofollow"
                        href="<?php echo Url::buildUrl("body", $category->category_slug, false); ?>"
                        class="item">
                        <strong><?php echo $category->category_name; ?></strong>
                     </a>
                  </div>
                  <div class="columns auto">
                     <span class="wojo demi text">(<?php echo $category->total; ?>)</span>
                  </div>
               </div>
            <?php endforeach; ?>
         </div>
