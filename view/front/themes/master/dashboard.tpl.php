   ...
   <div class="wojo-grid">
      ...
      <div class="row gutters align center">
         <div class="columns screen-30">
            <div class="wojo primary inverted simple message">
               <i class="icon large box"></i>
         ...
         <div class="columns screen-30">
            <div class="wojo primary inverted simple message">
               <i class="icon large calendar range"></i>
               <div class="content margin left">
                  ...
                  <div id="item_<?php echo $row->id; ?>"
                     ...
                     <div class="wojo relaxed list margin bottom">
                        ...
                        <div class="item">
                           ...
                           <span class="small margin left"><?php echo Lang::$word->LISTINGS; ?></span>
                        </div>
                        <div class="item">
                           <i class="icon credit card"></i><?php echo Utility::formatMoney($row->price); ?>
                        </div>
                     </div>
                     <p class="wojo small text"><?php echo $row->description; ?></p>
                     <?php if (App::Auth()->membership_id != $row->id): ?>
                        <button type="button" class="wojo primary fluid button mCart"
                     ...
                     <?php else: ?>
                        <div class="wojo simple disabled button fluid"><?php echo Lang::$word->MSM_ACTIVE; ?></div>
                     <?php endif; ?>
                  </div>
               </div>
            <?php endforeach; ?>
