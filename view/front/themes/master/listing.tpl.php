      ...
      <div class="row big gutters">
         <div class="columns screen-60 tablet-60 mobile-100 phone-100">
            <div class="wojo simple basic fitted segment">
                  ...
                  <div id="mcarousel" class="wSlider"
                     ...
                     <?php foreach ($this->gallery as $rows): ?>
                        <a class="wojo very rounded image lightbox" data-title="<?php echo $rows->title; ?>"
                           data-gallery="photos" href="<?php echo UPLOADURL . '/listings/pics' . $this->row->id . '/' . $rows->photo; ?>">
                           <img src="<?php echo UPLOADURL . '/listings/pics' . $this->row->id . '/' . $rows->photo; ?>" alt="">
                        </a>
                     <?php endforeach; ?>
                     <?php unset($rows); ?>
                     <?php if ($this->row->ylink): ?>
                        <a class="wojo very rounded image lightbox" data-wbox="video" href="https://www.youtube.com/watch?v=<?php echo $this->row->ylink; ?>">
                           <img src="<?php echo UPLOADURL; ?>/Play_Button.svg" alt="">
                        </a>
                     <?php endif; ?>
                  </div>
               <?php else: ?>
               ...
               <?php if ($this->gallery): ?>
                  <div id="scarousel" class="wSlider mt2 small spaced"
                     ...
                     <?php foreach ($this->gallery as $rows): ?>
                        <a class="wojo very rounded color image">
                           <img src="<?php echo UPLOADURL . '/listings/pics' . $this->row->id . '/thumbs/' . $rows->photo; ?>" alt="">
                        </a>
                     <?php endforeach; ?>
                     <?php unset($rows); ?>
                     <?php if ($this->row->ylink): ?>
            ...
            <?php if ($this->row->file): ?>
               ...
               <a href="<?php echo UPLOADURL . '/listings/files/' . $this->row->file; ?>">
                  <img
                    src="<?php echo UPLOADURL; ?>/images/pdficon.svg" class="wojo small inline image" alt="">
               </a>
            <?php endif; ?>
                  ...
                  <?php foreach ($this->features as $srow): ?>
                     <div class="columns">
                        <div class="wojo icon text">
                           <i class="primary icon asterisk"></i><?php echo $srow->name; ?></div>
                     </div>
                  <?php endforeach; ?>
               </div>
            <?php endif; ?>
            ...
            <div class="wojo native sticky">
               ...
               <div class="wojo basic light bg top attached segment">
                  <div class="wojo small items">
                     <div class="item">
                        <div class="columns">
                           <span class="wojo demi text"><?php echo Lang::$word->LST_MAKE; ?>:</span>
                        </div>
                        <div class="columns"><?php echo $this->row->make_name; ?></div>
                     </div>
                     <div class="item">
                        <div class="columns">
                           <span class="wojo demi text"><?php echo Lang::$word->LST_MODEL; ?>:</span>
                        </div>
                        <div class="columns"><?php echo $this->row->model_name; ?></div>
                     </div>
                     <div class="item">
                        <div class="columns">
                           <span class="wojo demi text"><?php echo Lang::$word->LST_EXTC; ?>:</span>
                        </div>
                        <div class="columns"><?php echo $this->row->color_e; ?></div>
                     </div>
                     <div class="item">
                        <div class="columns">
                           <span class="wojo demi text"><?php echo Lang::$word->LST_INTC; ?>:</span>
                        </div>
                        <div class="columns"><?php echo $this->row->color_i; ?></div>
                     </div>
                     <div class="item">
                        <div class="columns">
                           <span class="wojo demi text"><?php echo Lang::$word->LST_TRANS; ?>:</span>
                        </div>
                        <div class="columns"><?php echo $this->row->trans_name; ?></div>
                     </div>
                     <div class="item">
                        <div class="columns">
                           <span class="wojo demi text"><?php echo Lang::$word->LST_COND; ?>:</span>
                        </div>
                        <div class="columns"><?php echo $this->row->condition_name; ?></div>
                     </div>
                     <div class="item">
                        <div class="columns">
                           <span class="wojo demi text"><?php echo Lang::$word->LST_YEAR; ?>:</span>
                        </div>
                        <div class="columns"><?php echo $this->row->year; ?></div>
                     </div>
                     <div class="item">
                        <div class="columns">
                           <span class="wojo demi text"><?php echo Lang::$word->LST_FUEL; ?>:</span>
                        </div>
                        <div class="columns"><?php echo $this->row->fuel_name; ?></div>
                     </div>
                     <div class="item">
                        <div class="columns">
                           <span class="wojo demi text"><?php echo Lang::$word->LST_ODM; ?>:</span>
                        </div>
                        <div
                     ...
                     <div class="item">
                        <div class="columns">
                           <span class="wojo demi text"><?php echo Lang::$word->LST_DOORS; ?>:</span>
                        </div>
                        <div class="columns"><?php echo $this->row->doors; ?></div>
                     </div>
                     <?php if ($this->row->torque): ?>
                        <div class="item">
                           <div class="columns">
                              <span class="wojo demi text"><?php echo Lang::$word->LST_TORQUE; ?>:</span>
                           </div>
                           <div class="columns"><?php echo $this->row->torque; ?></div>
                        </div>
                     <?php endif; ?>
                     <?php if ($this->row->engine): ?>
                        <div class="item">
                           <div class="columns">
                              <span class="wojo demi text"><?php echo Lang::$word->LST_ENGINE; ?>:</span>
                           </div>
                           <div class="columns"><?php echo $this->row->engine; ?></div>
                        </div>
                     <?php endif; ?>
                     <?php if ($this->row->drive_train): ?>
                        <div class="item">
                           <div class="columns">
                              <span class="wojo demi text"><?php echo Lang::$word->LST_TRAIN; ?>:</span>
                           </div>
                           <div class="columns"><?php echo $this->row->drive_train; ?></div>
                        </div>
                     <?php endif; ?>
                     <?php if ($this->row->horse_power): ?>
                        <div class="item">
                           <div class="columns">
                              <span class="wojo demi text"><?php echo Lang::$word->LST_POWER; ?>:</span>
                           </div>
                           <div class="columns"><?php echo $this->row->horse_power; ?></div>
                        </div>
                     <?php endif; ?>
                     <?php if ($this->row->top_speed): ?>
                        <div class="item">
                           <div class="columns">
                              <span class="wojo demi text"><?php echo Lang::$word->LST_SPEED; ?>:</span>
                           </div>
                           <div class="columns"><?php echo $this->row->top_speed; ?><?php echo ($this->core->odometer == "km")? 'km/h' : 'mph'; ?></div>
                        </div>
                     <?php endif; ?>
                     <?php if ($this->row->towing_capacity): ?>
                        <div class="item">
                           <div class="columns">
                              <span class="wojo demi text"><?php echo Lang::$word->LST_TOWING; ?>:</span>
                           </div>
                           <div class="columns"><?php echo $this->row->towing_capacity; ?></div>
                        </div>
                     <?php endif; ?>
                     <?php if ($this->row->vin): ?>
                        <div class="item">
                           <div class="columns">
                              <span class="wojo demi text"><?php echo Lang::$word->LST_VIN; ?>:</span>
                           </div>
                           <div class="columns"><?php echo $this->row->vin; ?></div>
                        </div>
                     <?php endif; ?>
                     <?php if ($this->row->lplate): ?>
                        <div class="item">
                           <div class="columns">
                              <span class="wojo demi text"><?php echo Lang::$word->LST_LPLATE; ?>:</span>
                           </div>
                           <div class="columns">
                                 <?php echo $this->row->lplate; ?>
                           </div>
                        </div>
                     <?php endif; ?>
                  </div>
               </div>
               <a class="wojo fluid basic primary button pnumber" data-number="<?php echo $this->location->phone; ?>">
                  <i class="icon phone"></i>
                  <span><?php echo substr($this->location->phone ?? "", 0, -4); ?>****-<?php echo strtolower(Lang::$word->REVEAL); ?></span>
               </a>
               <div class="vertical margin">
                  <a class="wojo fluid positive button" href="https://wa.me/<?php echo $this->location->phone; ?>">
                     <i class="icon whatsapp"></i><?php echo Lang::$word->CVW; ?></a>
               </div>
               ...
               <div class="mt2 center aligned">
                  <a target="_blank" data-content="Share on Facebook"
                     ...
                     class="wojo small primary inverted icon button">
            ...
            <div class="columns screen-40 tablet-40 mobile-100 phone-100">
               <div class="wojo attached basic segment">
                  ...
                  <div class="wojo relaxed list">
                     <div class="item">
                        <i class="icon primary geo"></i>
                        <?php echo $this->location->address; ?></div>
                     <a href="<?php echo Url::url("/seller", $this->location->name_slug); ?>" class="item">
                        <i class="icon car"></i>
                        <?php echo Lang::$word->HOME_MORES; ?></a>
                     <div class="item">
                        <i class="icon primary envelope"></i>
