      ...
      <div class="contents">
        <div class="row big gutters">
          <div class="columns mobile-100 phone-100">
            <p class="wojo small white dimmed text">When you visit or interact with our sites, services or tools, we or
              our authorised service providers may use cookies for storing information to help provide you with a
    ...
    <div class="copyright">
      <div class="wojo-grid">
        <div class="row small gutters align middle">
          <div class="columns phone-100">Copyright &copy;<?php echo date('Y') . ' ' . $this->core->company; ?> | Powered
            by: New Jersey Technology Group</div>
